...
Segments are purchase intents, not age bands. Maximum weightage in the survey is 75% (Size & Fit, and Wishlist comparison). Survey % is stated intent/check behaviour. VOC mentions size related public-review blockers in this corpus only.
- **Maximum survey weightage:** 75% (Size & Fit, and Wishlist comparison).

| Rank | Intent | When | Max weightage % | Barrier | VOC mentions |
| --- | --- | --- | --- | --- | --- |
| 1 | Personalised Size & Fit Confidence | Now | 75 | Fit and size doubt on the PDP / wishlist | 27 |
| 2 | Genuine Customer Reviews & Social Proof | Now | 68.8 | Doubt about authenticity, quality, and whose reviews to believe | 47 |
| 3 | Wishlist Comparison & Decision Engine | Next | 75 | Choice overload and off-platform price/product comparison | 85 |
| 4 | Return Policy Confidence & Inventory Clarity | Next | 56.3 | Fear of painful returns and unclear stock/price on the wishlist | 53 |
